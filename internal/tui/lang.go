...
var translations = map[string]map[string]string{
	"en": {
		...
		"update_installed":        "New binary installed at %s",
		"update_install_fallback": "Installed for the current user at %s. Run 'sudo make install' for a system-wide install.",
		"update_install_fail":     "Installing the new binary failed: %s",
	...
	"nl": {
		...
		"update_installed":        "Nieuw binary geïnstalleerd op %s",
		"update_install_fallback": "Voor de huidige gebruiker geïnstalleerd op %s. Voer 'sudo make install' uit voor een systeemwijde installatie.",
		"update_install_fail":     "Installeren van het nieuwe binary mislukt: %s",
