...
var translations = map[string]map[string]string{
	"en": {
		...
		"main_more":      "Menu",
		"main_clear":     "Clear",
		"calc_help_home": "Tab: next field | F2: route | Enter: calculate | 1: menu | 2: clear | Esc: blur",
	...
	"nl": {
		...
		"main_more":      "Menu",
		"main_clear":     "Wissen",
		"calc_help_home": "Tab: volgend veld | F2: route | Enter: berekenen | 1: menu | 2: wissen | Esc: velden loslaten",
