...
8. Switch Branch - Switch between dev and supported stable branches (e.g. v1.1.0); retired releases v1.0.0 and v1.0.1 are not listed; local changes are stashed before the switch and restored after it
...
- `v1.1.0` - Stable release branch. This is the current stable version. Recommended for installs (documented `git checkout v1.1.0` in the README). Bug fixes only. Retired: `v1.0.0`, `v1.0.1` (not offered in the TUI).
...
- Switch between dev and supported stable branches from the TUI (retired: v1.0.0, v1.0.1)
