...
8. Switch Branch - Switch between dev and stable branches (e.g. v1.0.0, v1.0.1), including older releases; local changes are stashed before the switch and restored after it
